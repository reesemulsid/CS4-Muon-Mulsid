package q2ex6;
/*
You may make changes to the Monster class as needed, whether to change the access modifier,
make modifications to the constructor, or split parts of the class to different methods.
Please note in the comments of your code any change you introduce to the Monster class.
*/
import java.util.ArrayList;

public class Monster {
    protected final String name, type, strongAgainst, weakAgainst; //changed private to protected
    protected int maxHP, hp, atk, def, xp, lvl; //changed private to protected
