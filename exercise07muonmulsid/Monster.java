...
/*
Considering that all Monsters should have a type, convert the Monster class
into an abstract class and change special to an abstract method.
Monster interact: prints the name and type of the monster
*/
...
public abstract class Monster implements Interactive {
    ...
    public void interact(){
        System.out.println(name + " is " + type + " type.");
    }
